    ...
    <v-container>
      ...
      <v-row class="pa-1">
        <v-col cols="12" md="6">
          ...
          <v-row class="pa-5">
            <p class="text-white">
              The app uses the following internal dependencies :
            </p>
          </v-row>
          ...
          >
            <thead>
              <tr>
                <th class="text-left text-white" width="50%">Package</th>
                <th class="text-left text-white" width="10%">Version</th>
              </tr>
            </thead>
            <tbody>
      ...
      <v-row>
        <v-col cols="12">
          <p class="text-white">
            ...
            <br />
            Copyright © 2019 - {{ new Date().getFullYear() }} — Geode-solutions
