...
pyinstaller --onefile --collect-data opengeodeweb_viewer --collect-all vtkmodules electron-server/venv_viewer/Lib/site-packages/geodeapp_viewer/app.py --distpath electron-server/dist_viewer -n geodeapp_viewer