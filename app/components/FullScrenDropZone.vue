...
function onDrop(event) {
  ...
  if (!event.dataTransfer) {
    feedbackStore.add_error(ERROR_500, "/internal", "Internal error", "No file dropped.");
    UIStore.setShowDropZone(false);
    return;
  }
  ...
  >
    ...
    >
      ...
      >
        ...
        >
        <h2 class="text-h4 font-weight-bold mb-3 text-black font-michroma">Drop files here</h2>
